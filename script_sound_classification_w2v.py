...
# loading baskets
b_UrbanSound8K = c.load_basket_pickle('UrbanSound8K') # This basket has been actualize in my machine (cleaning + added clas)
b_FreesoundDb = c.load_basket_pickle('FreesoundDb') # FreesoundDb exist only on devaraya node
...
model_UrbanSound8K = Word2Vec(X, size=30, window = 1000, min_count = 5, workers = 2)
model_FreesoundDb = Word2Vec(X, size=30, window = 1000, min_count = 5, workers = 2)
